...
#define MY_DEFAULT_HOST_NAME			"IOR"
...
#define MY_DEFAULT_IP_ADDR_BYTE3        (100ul)//(1ul)// (253ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (32ul)//(200ul)// (176ul)
...
#define MY_DEFAULT_GATE_BYTE3           (1ul)// (253ul)
#define MY_DEFAULT_GATE_BYTE4           (100ul)// (1ul)

#define MY_DEFAULT_PRIMARY_DNS_BYTE1	(192ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE2	(168ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE3	(253ul)
...
#pragma idata TCP_CONFIG
		...
		//	{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 200, 100},
...
//			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 200, 200},
			...
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 20, 20},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 20, 20},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 20, 20},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 20, 20},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 20, 20},
...
// -- HTTP2 Server options -----------------------------------------------
	...
	#define HTTP_DEFAULT_FILE		"protect/config.htm"
	#define HTTPS_DEFAULT_FILE		"protect/config.htm"
